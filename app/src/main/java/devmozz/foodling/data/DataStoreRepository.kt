...
import devmozz.foodling.util.Constants.Companion.PREFERENCES_MEAL_TYPE_ID
import devmozz.foodling.util.Constants.Companion.PREFERENCES_NAME
...
class DataStoreRepository @Inject constructor(@ApplicationContext private val context: Context) {
    ...
    val readMealTypeAndDietType: Flow<MealTypeAndDietType> = context.dataStore.data
        .catch { exception ->
            when (exception) {
                is IOException -> {
...
data class MealTypeAndDietType(
